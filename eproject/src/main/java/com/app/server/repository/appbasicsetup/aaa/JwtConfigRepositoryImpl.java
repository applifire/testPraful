...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "3", comments = "Repository for JwtConfig Master table Entity", complexity = Complexity.LOW)
public class JwtConfigRepositoryImpl extends SearchInterfaceImpl implements JwtConfigRepository<JwtConfig> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        JwtConfig object = emanager.find(com.app.shared.appbasicsetup.aaa.JwtConfig.class, id);
