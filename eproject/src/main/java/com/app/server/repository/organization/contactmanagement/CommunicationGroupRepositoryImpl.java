...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "3", comments = "Repository for CommunicationGroup Master table Entity", complexity = Complexity.LOW)
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws Exception {
        ...
        List<CommunicationGroup> query = emanager.createNamedQuery("CommunicationGroup.findAll").getResultList();
     ...
     * @Params Object of CommunicationGroup
     * @throws java.lang.Exception
     */
    @Transactional
    @Override
    ...
    /**
     * Saves the list of new <CommunicationGroup> object.
     * @return java.util.List<CommunicationGroup>
     * @Params list of CommunicationGroup
     * @throws java.lang.Exception
     */
    @Transactional
    @Override
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            CommunicationGroup obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        CommunicationGroup object = emanager.find(com.app.shared.organization.contactmanagement.CommunicationGroup.class, id);
    ...
    /**
     * Return CommunicationGroup object by filtering on refernce key <commGroupId>
     * @return CommunicationGroup
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception {
        EntityManager emanager = emfResource.getResource();
        Query query = emanager.createNamedQuery("CommunicationGroup.findById");
        query.setParameter("commGroupId", commGroupId);
        CommunicationGroup listOfCommunicationGroup = (CommunicationGroup) query.getSingleResult();
