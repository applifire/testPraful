...
public class TimezoneServiceImpl extends TimezoneService {
    ...
    /**
     * Retrieve list of  <Timezone> object
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<Timezone> lsttimezone = timezonerepo.findAll();
    ...
    /**
     * Saves the new  list of new <Timezone> object.
     * @return HttpEntity<ResponseBean>
     * @Params entity type:- List<Timezone>
    ...
    /**
     * Retrieves list of  <Timezone> object
     * @return HttpEntity<ResponseBean>
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        Timezone lsttimezone = timezonerepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGLM124990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Timezone"));
        responseBean.add("data", lsttimezone);
        Log.out.println("ORGLM124990200", runtimeLogInfoHelper.getRequestHeaderBean(), "TimezoneServiceImpl", "findById", "Timezone");
        return new ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
