...
@Table(name = "ast_JwtConfig_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "3", comments = "JwtConfig", complexity = Complexity.LOW)
...
public class JwtConfig implements Serializable, CommonEntityInterface, Comparator<JwtConfig> {
    ...
    private static final long serialVersionUID = 1471588736052L;
