...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "3", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {

    private static final long serialVersionUID = 1471588730614L;
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append((appServerSessionId == null ? " " : appServerSessionId) + ",").append((loginTime == null ? " " : loginTime) + ",").append((lastAccessTime == null ? " " : lastAccessTime) + ",").append((logoutTime == null ? " " : logoutTime));
        return sb.toString();
    }
