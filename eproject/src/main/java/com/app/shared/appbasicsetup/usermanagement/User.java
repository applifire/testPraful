...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "3", comments = "User", complexity = Complexity.LOW)
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    private static final long serialVersionUID = 1471588724094L;
