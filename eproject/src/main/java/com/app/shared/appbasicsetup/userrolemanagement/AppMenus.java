...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "3", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    private static final long serialVersionUID = 1471588733163L;
    ...
    public void setGoLiveDate(Timestamp _goLiveDate) {
        this.goLiveDate = _goLiveDate;
    }
