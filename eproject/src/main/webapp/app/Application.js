 ...
 */
Ext.define('Eproject.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Eproject.view.databrowsercalendar.DBCalendar",
			"Eproject.view.fw.component.CustomComboBox" ,"Eproject.view.fw.component.TreeComponent"],
	...
	stores : [ 'Eproject.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Eproject.view.login.SessionLogin').center();
