Ext.define('Eproject.eproject.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Eproject.eproject.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
