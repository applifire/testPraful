Ext.define('Eproject.eproject.web.com.controller.organization.contactmanagement.CommunicationGroupMainController', {
     extend: 'Eproject.view.fw.frameworkController.FrameworkViewController',
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Eproject.eproject.shared.com.model.organization.contactmanagement.CommunicationGroupModel',
               autoLoad: true,
