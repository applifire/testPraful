Ext.define('Eproject.eproject.web.com.controller.organization.contactmanagement.CoreContactsMainController', {
     extend: 'Eproject.view.fw.frameworkController.AggregateViewController',
     ...
     onCommGroupIdChangeCommType: function(me, newValue, oldValue, eOpts) {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    ...
                    commTypeCombo.setValue();
                    var responseText = Ext.JSON.decode(response.responseText);
                    commTypeCombo.setComboData(responseText.response.data);
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Eproject.eproject.shared.com.model.organization.contactmanagement.CoreContactsModel',
               autoLoad: true,
