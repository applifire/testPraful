Ext.define('Eproject.eproject.web.com.controller.organization.contactmanagement.GenderMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Eproject.eproject.shared.com.model.organization.contactmanagement.GenderModel',
               autoLoad: true,
