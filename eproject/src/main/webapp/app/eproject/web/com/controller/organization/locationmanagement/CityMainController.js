Ext.define('Eproject.eproject.web.com.controller.organization.locationmanagement.CityMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Eproject.eproject.shared.com.model.organization.locationmanagement.CityModel',
               autoLoad: true,
