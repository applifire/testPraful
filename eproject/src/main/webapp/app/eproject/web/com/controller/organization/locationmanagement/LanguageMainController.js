Ext.define('Eproject.eproject.web.com.controller.organization.locationmanagement.LanguageMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Eproject.eproject.shared.com.model.organization.locationmanagement.LanguageModel',
               autoLoad: true,
