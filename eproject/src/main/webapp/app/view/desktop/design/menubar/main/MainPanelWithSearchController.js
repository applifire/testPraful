Ext.define('Eproject.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Eproject.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Eproject.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Eproject.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Eproject.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Eproject.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Eproject.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Eproject.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
