 ...
 */
Ext.define('Eproject.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Eproject.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Eproject.view.fw.component.DateTimePicker(o);
    },
