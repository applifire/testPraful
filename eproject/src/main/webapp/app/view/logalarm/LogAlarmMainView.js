 ...
 * 
 */
Ext.define('Eproject.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Eproject.view.logalarm.LogAlarmMainViewController',
			'Eproject.view.logalarm.tree.LogAlarmTreePanel',
			'Eproject.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
