 ...
 * 
 */
Ext.define('Eproject.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Eproject.view.logalarm.mainscreen.AddLogAlarmController',
			'Eproject.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Eproject.view.logalarm.mainscreen.AppAlarmPanel',
