...
Ext
		.define(
				'Eproject.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Eproject.view.logger.tabs.details.DetailsTab',
							'Eproject.view.logger.tabs.fileconnector.FileConnectorTab',
							'Eproject.view.logger.tabs.dbconnector.DBConnectorTab',
							'Eproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Eproject.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Eproject.view.logger.LogConfigurationTabPanelController',
