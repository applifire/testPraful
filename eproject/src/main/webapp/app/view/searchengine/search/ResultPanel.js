Ext
		.define(
				'Eproject.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Eproject.view.searchengine.search.SearchEngineMainPanelController','Eproject.view.searchengine.search.PanelHeaderField' ,'Eproject.view.searchengine.search.ReportGridView','Eproject.view.searchengine.search.ReportChartView','Eproject.view.searchengine.search.documentView','Eproject.view.searchengine.search.DouMeanView','Eproject.view.googlemaps.map.MapPanel'],
