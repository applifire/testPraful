 ...
 * 
 */
Ext.define('Eproject.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Eproject.view.securityconfig.SecurityConfigController',
			'Eproject.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
