Ext.define('Eproject.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Eproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Eproject.model.AddUserDataModel' ],
