Ext.define('Eproject.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Eproject.view.usermanagement.enduser.UserProfileController', 'Eproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Eproject.model.AddUserDataModel' ],
