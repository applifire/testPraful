...
folder are mapped to the application's root namespace, 'Eproject'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Eproject' in the same way
as `"Eproject/sass/src"`.
