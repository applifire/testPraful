...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainHelp("d7ceEuhgl5B7d79kwTBY2AmM0ElHClBWywwncZVLXOlcWFmxXT");
        useraccessdomain.setDomainIcon("8jsOIVAaFM09bXfWXNGABE07t21RrDLgfnNdLrGaurnZfK7zMC");
        useraccessdomain.setDomainName("vWuSipuoBKNcopZdFPlIwsA9Dn5FyN7FC1KbGcTE1ljiS6RAB6");
        useraccessdomain.setDomainDescription("Dw0WTDhxYZatijw7QR79KTgT7nnmbgvUJHChim2Hx674EEkedQ");
        ...
        useraccesslevel.setLevelIcon("7BxguuET5rJVCbdX8ysqpoSYpoyX2ZILTlzWMFIBcbguFxuBZT");
        useraccesslevel.setLevelHelp("fofUBei76LTYIM8WZa8mvmsU7cJ1IS7NixRLcqhh343rQfmVoK");
        useraccesslevel.setLevelName("LR4ulu4KBNmEdZGNups72LshFOiBFbuojfhpLylpKpjpeQpLl6");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelDescription("W9I6Lv3VS2e2LJLKri4Q5DpCG9EjGGtxCmNIat0P85YrsGI59Y");
        ...
        user.setPasswordExpiryDate(new java.sql.Timestamp(1471588724698l));
        user.setIsDeleted(1);
        user.setChangePasswordNextLogin(1);
        user.setAllowMultipleLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(2853);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("xf5dkF8k05X0tU2gLB0q7G88H1VGXjtb0g2GWAQPQoKa6lZDHm");
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1471588724729l));
        user.setUserAccessCode(8660);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("IklhaJ3tPiqGP2a48elKMEI35RoUcmfv49TIgwMAdqfU9kFAbI");
        Question question = new Question();
        question.setQuestionIcon("pHMWq3XMCibZKzd7OAz0LGfYRPKpbiNmw9shE6dwv8yuxnMn8R");
        question.setQuestion("PIR5xeVSAws1XkdN3McGfqnatRl0ZpsWfSGgzjToopGJG0YGkE");
        question.setLevelid(6);
        question.setQuestionDetails("5oK4Svwb2o");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("yLMlepmHgltEAoR2o31xx4p0DcwwEEOnfa2JdPTvmXwdpg6uxO");
        passrecovery.setUser(user);
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setPassword("CtkBG9eoCzhcCFU8LcztN1TO5WIpJw8GGDrC8mjBHpdu0FAZqC");
        userdata.setPassword("SfQqKXjic667XT8M01tyFKDJ9NrZZicSxGLwDKkVW15s4cpKKV");
        userdata.setUser(user);
        userdata.setLast5Passwords("v3bu9l8fCgXFPf0K68RHpV4aY7A1qmIlEyebwDBcPmquEHivHD");
        userdata.setOneTimePassword("6VeAt397wZWqVP245HjBY7K9oQZiTAWJ");
        userdata.setOneTimePasswordExpiry(6);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1471588724882l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 102524));
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "txQXR3oKchUMpb1QSq3zWsLDx0LCfHZBYzl8cOE5qPPETZbrxMDQdvLIXf8k6CkOs"));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 3800));
