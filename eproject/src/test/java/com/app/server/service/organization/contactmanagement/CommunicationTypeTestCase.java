...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    /**
     * CommunicationTypeRepository Variable
     */
    @Autowired
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupDescription("rzz1jFwCHMBCel3Z8caHT6FrgAeYkqu1eOs9O5s0sUZGSY1pXt");
        communicationgroup.setCommGroupName("ExghEHNlNSepS50GHa9hypyEtrBGHEUOcq77CbhcklAcKVgTwd");
        ...
        communicationtype.setCommTypeName("ilU3m35SIs4eKdb3Mays9eTguqsGccY9ePY55qUKHxXOS0uDsF");
        communicationtype.setCommTypeDescription("yA30YfJUbvXHZTM80SLMstIkoZCBoTJLj8IJZWazi5aOJnsC9g");
    ...
    public void test2Update() {
        try {
            Assert.assertNotNull(map.get("CommunicationTypePrimaryKey"));
            ...
            communicationtype.setCommTypeName("c2aweAzFVkLa0zWeFXgbr1f3Iq34g5wvpnpy3ThgKtDRyqaG1y");
            communicationtype.setCommTypeDescription("Hcdk3H8WqnV6zZFA2CurPXMaoflZ8EN9pjyph5U43Q7uZejCZw");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(NOT_NULL, 1, "commTypeName", null));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "i1dVf0EUptdIeH4tNDHziXvoDSICraVNsFNxnlFujkDIlJFWH0xM4SdySM8pyLTuMc5fxkxxZuKMcTPXXJ6GgvzwpKPoqSJVtLI9QXlneDiBy6XFOeUPwKF1xo3h8h1f9"));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
